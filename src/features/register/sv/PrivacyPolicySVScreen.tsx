    ...
    return (
      ...
      >
        ...
        <RegularText>
          ...
          Europeiska unionen (eller det Europeiska ekonomiska samarbetsområdet) där du arbetar, vanligtvis bor eller där
          eventuell påstådd överträdelse av dataskyddslagen inträffat. Tillsynsmyndigheten i Storbritannien är
